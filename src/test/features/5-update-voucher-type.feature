...
Feature: Update Voucher types
  ...
  Background:
    Given exist the voucher types:
      ...
      | BVOUCHER1MONTHS | Tinder 1 m | 1 Months       |       | 9.99   | INR      | tinder   | IN      | PAYTM           | shop1 | true    | 01/01/2020 08:15:00 | 21/06/2020 08:15:00 | 1        |
      | WVOUCHER1MONTHS | Tinder 3 m | 1 Months VDFAU | sale  | 9.99   | INR      | tinder   | IN      | VDFAU           | shop1 | true    | 01/01/2020 08:15:00 | 21/06/2020 08:15:00 | 0        |

  Scenario: Voucher type updated
    When the operator wants to update the voucher type 'BVOUCHER1MONTHS':
      | product       | description | promo | amount | currency | merchant | country | paymentProvider | shop  | enabled | startDate  				 | endDate    				 | priority |
      | Tinder 1 m UP | 1 Months UP | p1m   | 19.99  | USD      | bumble   | DE      | VDFAU           | shop2 | false   | 01/02/2020 08:15:00 | 21/07/2020 08:15:00 | 1        |
