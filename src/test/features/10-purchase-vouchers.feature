...
Feature: Purchase Voucher File
  ...
  Scenario Outline: Voucher file purchased
    When the operator wants to 'purchase' the voucher file for the type '<typeId>' with the voucher '<voucher>'
  ...
  Scenario Outline: Voucher purchase without mandatory fields
    When the operator wants to 'purchase' the voucher without field '<field>'
